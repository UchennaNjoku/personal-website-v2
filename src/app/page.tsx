              ...
              <div className="experience-highlight">
                ...
                <div className="space-y-6">
                  ...
                  <div className="group">
                    <Drawer>
                      <DrawerTrigger>
                        <div className="flex flex-col w-full h-fit p-4 rounded-lg border border-[#433E0E] border-opacity-20 hover:border-opacity-40 transition-all duration-300 hover:shadow-lg hover:transform hover:scale-[1.02]">
                          <div className="flex flex-row items-center w-full h-fit">
                            <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect width="24" height="24" rx="4" fill="#0066CC" />
                              <text x="12" y="16" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold">GS</text>
                            </svg>
                            <div className="flex flex-col ml-6 w-fit h-fit">
                              <h1 className="text-2xl md:text-4xl font-bold">Goldman Sachs</h1>
                              <p className="text-sm md:text-base opacity-70 mb-2">Software Engineer Intern • 2025</p>
                      ...
                      <DrawerTrigger>
                        <div className="flex flex-col w-full h-fit p-4 rounded-lg border border-[#433E0E] border-opacity-20 hover:border-opacity-40 transition-all duration-300 hover:shadow-lg hover:transform hover:scale-[1.02]">
                          <div className="flex flex-row items-center w-full h-fit">
                            ...
                            <div className="flex flex-col ml-6 w-fit h-fit">
                              <h1 className="text-2xl md:text-4xl font-bold">Amazon (AWS)</h1>
                              <p className="text-sm md:text-base opacity-70 mb-2">Software Engineer Intern • 2023-2024</p>
                              <div data-sticky className={`flex flex-row items-center w-fit h-fit ${isDarkMode ? 'text-[#433E0E]' : 'text-[#433E0E]'} group-hover:text-[#81901D] transition-colors`}>
                                <svg width="20px" height="20px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 14.7071C12.3166 15.0976 11.6834 15.0976 11.2929 14.7071L6.29289 9.70711C5.90237 9.31658 5.90237 8.68342 6.29289 8.29289C6.68342 7.90237 7.31658 7.90237 7.70711 8.29289L12 12.5858L16.2929 8.29289C16.6834 7.90237 17.3166 7.90237 17.7071 8.29289C18.0976 8.68342 18.0976 9.31658 17.7071 9.70711L12.7071 14.7071Z" fill="currentColor"></path> </g></svg>
                                <p className="text-sm ml-1 font-medium">explore details</p>
                              </div>
                      ...
                      <DrawerTrigger>
                        <div className="flex flex-col w-full h-fit p-4 rounded-lg border border-[#433E0E] border-opacity-20 hover:border-opacity-40 transition-all duration-300 hover:shadow-lg hover:transform hover:scale-[1.02]">
                          <div className="flex flex-row items-center w-full h-fit">
                            ...
                            <div className="flex flex-col ml-6 w-fit h-fit">
                              <h1 className="text-2xl md:text-4xl font-bold">Cisco</h1>
                              <p className="text-sm md:text-base opacity-70 mb-2">Software Engineer Intern • 2025</p>
                              <div data-sticky className={`flex flex-row items-center w-fit h-fit ${isDarkMode ? 'text-[#433E0E]' : 'text-[#433E0E]'} group-hover:text-[#81901D] transition-colors`}>
                                <svg width="20px" height="20px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 14.7071C12.3166 15.0976 11.6834 15.0976 11.2929 14.7071L6.29289 9.70711C5.90237 9.31658 5.90237 8.68342 6.29289 8.29289C6.68342 7.90237 7.31658 7.90237 7.70711 8.29289L12 12.5858L16.2929 8.29289C16.6834 7.90237 17.3166 7.90237 17.7071 8.29289C18.0976 8.68342 18.0976 9.31658 17.7071 9.70711L12.7071 14.7071Z" fill="currentColor"></path> </g></svg>
                                <p className="text-sm ml-1 font-medium">explore details</p>
                      ...
                      <DrawerTrigger>
                        <div className="flex flex-col w-full h-fit p-4 rounded-lg border border-[#433E0E] border-opacity-20 hover:border-opacity-40 transition-all duration-300 hover:shadow-lg hover:transform hover:scale-[1.02]">
                          <div className="flex flex-row items-center w-full h-fit">
                            ...
                            <div className="flex flex-col ml-6 w-fit h-fit">
                              <h1 className="text-2xl md:text-4xl font-bold">General Motors</h1>
                              <p className="text-sm md:text-base opacity-70 mb-2">EV Challenge Winner • 2023</p>
                              <div data-sticky className={`flex flex-row items-center w-fit h-fit ${isDarkMode ? 'text-[#433E0E]' : 'text-[#433E0E]'} group-hover:text-[#81901D] transition-colors`}>
                                <svg width="20px" height="20px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 14.7071C12.3166 15.0976 11.6834 15.0976 11.2929 14.7071L6.29289 9.70711C5.90237 9.31658 5.90237 8.68342 6.29289 8.29289C6.68342 7.90237 7.31658 7.90237 7.70711 8.29289L12 12.5858L16.2929 8.29289C16.6834 7.90237 17.3166 7.90237 17.7071 8.29289C18.0976 8.68342 18.0976 9.31658 17.7071 9.70711L12.7071 14.7071Z" fill="currentColor"></path> </g></svg>
                                <p className="text-sm ml-1 font-medium">explore details</p>
                              </div>
