...
export default function Home() {
  ...
  return (
    <>
    <StickyCursor />
    <main className="bg relative w-full overflow-x-hidden">
      <header className='w-full absolute top-0 p-4 md:p-10'>
            <div className="flex w-full justify-between items-center m-auto max-w-8xl">
                ...
                <div className="hidden md:flex flex-grow justify-center items-center space-x-6 md:space-x-10"> 
            ...
            {/* Mobile Menu */}
            <div id="mobile-menu" className="hidden w-full bg-white shadow-md absolute top-16 left-0 z-50 rounded-md mx-auto px-4 py-2">
              <div className="flex flex-col space-y-4 py-4">
                <button onClick={() => {
                  scrollToRef(experienceRef);
                  const mobileMenu = document.getElementById('mobile-menu');
                  if (mobileMenu) mobileMenu.classList.add('hidden');
                }} className='text-black font-normal py-2 hover:font-medium'>/experience</button>
                <button onClick={() => {
                  scrollToRef(worksRef);
                  const mobileMenu = document.getElementById('mobile-menu');
                  if (mobileMenu) mobileMenu.classList.add('hidden');
                }} className='text-black font-normal py-2 hover:font-medium'>/works</button>
                <button onClick={() => {
                  scrollToRef(contactRef);
                  const mobileMenu = document.getElementById('mobile-menu');
                  if (mobileMenu) mobileMenu.classList.add('hidden');
                }} className='text-black font-normal py-2 hover:font-medium'>/contact</button>
              </div>
            </div>
      </header>
      <section className="flex flex-col m-auto justify-center min-h-screen px-4 py-10 md:py-0 md:h-screen max-w-5xl text-black">
        <div >

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl m-0 leading-tight">Hi,<span role="img" className='waveanim' aria-label="sheep">👋🏼</span> I&apos;m <span className="line-through"><b>your next software developer,</b></span> <b>Uchenna Njoku</b></h1>
          <h3 className="text-lg md:text-2xl m-0 mt-2">specializing in crafting <b>unique digital experiences. </b></h3>
        
        </div>
      </section>

      <section className="flex flex-col min-h-screen m-auto justify-center px-4 py-10 md:py-0 md:h-screen max-w-5xl text-black">
        
        <div ref={experienceRef} className="flex flex-col">
          <div className="flex flex-col space-y-5">
            <h2 className="text-3xl md:text-4xl lg:text-5xl m-0">I&apos;m a software engineer based in Daytona Beach, Florida</h2>
            <p className="text-lg md:text-xl lg:text-2xl m-0 mt-3">I have a knack for full-stack development, clean design patterns, human-computer interactions, and everything in between. I&apos;m quietly confident, naturally curious, and perpetually improving my chops one problem at a time!</p>
            <p className="text-xl md:text-2xl font-medium m-0 mt-6">previously worked at:</p>
                    ...
                    <div className="flex flex-col w-fit h-fit">
                      <div className="flex flex-row items-center w-full h-fit">
                        ...
                        <div className="flex flex-col ml-6 w-fit h-fit">
                          <h1 className="text-xl md:text-3xl">Amazon (AWS)</h1>
                        ...
                        <div className="flex flex-col items-center p-5">
                          ...
                          <div className="border-b pb-6 mb-6">
                            <h2 className="text-xl md:text-2xl font-semibold flex items-center">
                              ...
                              <span className="ml-auto text-sm text-gray-500">May 2024 - August 2024</span>
                            </h2>
                          ...
                          <div>
                            <h2 className="text-xl md:text-2xl font-semibold flex items-center">
                              <span>Software Engineer Intern</span>
                              <span className="ml-auto text-sm text-gray-500">May 2023 - August 2023</span>
                            </h2>
                            <div className="text-sm md:text-lg px-4 md:px-16 mt-4 space-y-2">
                  ...
                  <DrawerTrigger>
                    <div className="flex flex-col w-fit h-fit">
                      <div className="flex flex-row items-center w-full h-fit">
                        ...
                        <div className="flex flex-col ml-6 w-fit h-fit">
                          <h1 className="text-xl md:text-3xl">Cisco</h1>
                          <div data-sticky className="flex flex-row items-center w-fit h-fit text-black">
                            <svg width="36px" height="36px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="0.00024000000000000003"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 14.7071C12.3166 15.0976 11.6834 15.0976 11.2929 14.7071L6.29289 9.70711C5.90237 9.31658 5.90237 8.68342 6.29289 8.29289C6.68342 7.90237 7.31658 7.90237 7.70711 8.29289L12 12.5858L16.2929 8.29289C16.6834 7.90237 17.3166 7.90237 17.7071 8.29289C18.0976 8.68342 18.0976 9.31658 17.7071 9.70711L12.7071 14.7071Z" fill="#000000"></path> </g></svg>
                            <p className="text-lg">see more!</p>
                          </div>
                  ...
                  <DrawerTrigger>
                    <div className="flex flex-col w-fit h-fit">
                      <div className="flex flex-row items-center w-full h-fit">
                        ...
                        <div className="flex flex-col ml-6 w-fit h-fit">
                          <h1 className="text-xl md:text-3xl">General Motors EV Challenge</h1>
                          <div data-sticky className="flex flex-row items-center w-fit h-fit text-black">
                            <svg width="36px" height="36px" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="0.00024000000000000003"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 14.7071C12.3166 15.0976 11.6834 15.0976 11.2929 14.7071L6.29289 9.70711C5.90237 9.31658 5.90237 8.68342 6.29289 8.29289C6.68342 7.90237 7.31658 7.90237 7.70711 8.29289L12 12.5858L16.2929 8.29289C16.6834 7.90237 17.3166 7.90237 17.7071 8.29289C18.0976 8.68342 18.0976 9.31658 17.7071 9.70711L12.7071 14.7071Z" fill="#000000"></path> </g></svg>
                            <p className="text-lg">see more!</p>
                          </div>
...
<br/>Implementing efficiency-oriented solutions and innovations to address the challenges inherent in electric vehicles over the four-year EcoCar EV competition as part of the Connected and Autonomous Vehicles (CAVS) subteam.
      ...
      <section ref={worksRef} className="py-16 flex flex-col m-auto justify-center mb-20 md:mb-48 text-black px-4">
        <div className="w-full max-w-5xl m-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl">...some stuff I&apos;ve worked on 👨🏽‍💻</h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row max-w-5xl m-auto justify-between md:mt-8 gap-4">
          ...
          <div className="mt-6 md:mt-32 w-full flex flex-col md:items-end">
            <h1 className="text-gray-300 font-black text-5xl md:text-7xl">01</h1>
            <h1 className="text-3xl md:text-5xl font-medium text-gray-600">Thriv</h1>
            <p className="text-lg md:text-xl text-gray-400 font-regular w-full md:w-4/5">your personal fitness companion designed to help you dial in your fitness goals.</p>
            <p className="text-lg md:text-xl text-gray-400 font-regular w-full md:w-4/5">in development using React Native and Firebase<br/></p>
        ...
        <div className="flex flex-col md:flex-row max-w-5xl m-auto justify-between md:mt-8 gap-4">
          <div className="mt-6 md:mt-32 w-full md:py-14">
            <h1 className="text-gray-300 font-black text-5xl md:text-7xl">02</h1>
            <h1 className="text-3xl md:text-5xl font-medium text-gray-600">Munchies Recipes</h1>
            <p className="text-lg md:text-xl text-gray-400 font-regular w-full md:w-4/5">A recipe web application that helps you find the perfect recipe for any meal</p>
            <p className="text-lg md:text-xl text-gray-400 font-regular w-full md:w-4/5">- Developed using React and TailwindCSS<br/>- Leveraging the Spoonacular API to get results</p>
            <Button data-sticky variant="outline" className="h-fit w-fit mt-5">
        ...
        <div className="flex flex-col md:flex-row max-w-5xl m-auto justify-between md:mt-8 gap-4">
          ...
          <h1 className="text-gray-300 font-black text-7xl">03</h1>
            <h1 className="text-3xl md:text-5xl font-medium text-gray-600">Sentinel Staffing</h1>
            <p className="text-lg md:text-xl text-gray-400 font-regular w-full md:w-4/5 mt-3">Redesigned the web application portal for Sentinel Staffing Solutions. Developed using React and TailwindCSS</p>
            <div className="flex flex-row justify-start w-full md:w-4/5">
            <Button data-sticky variant="outline" className="h-fit w-fit mt-5">
      ...
      <footer ref={contactRef} className="bg-gray-950 rounded-t-3xl text-gray-50 pt-20 md:pt-36">
      <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
        <div className="space-y-3">
          ...
          <p className="mx-auto max-w-[600px] text-gray-300 text-sm md:text-base lg:text-lg xl:text-xl/relaxed dark:text-gray-700">
