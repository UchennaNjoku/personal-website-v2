                          ...
                          <DrawerDescription className="px-6 pb-6">
                            <div className="space-y-4">
                              <div className="border-b pb-4 mb-4">
                                <h2 className="text-lg md:text-xl font-semibold flex flex-col sm:flex-row sm:items-center gap-2">
                          ...
                          <DrawerDescription className="px-6 pb-6">
                            <div className="space-y-6">
                              <div className="border-b pb-4 mb-4">
                                <h2 className="text-lg md:text-xl font-semibold flex flex-col sm:flex-row sm:items-center gap-2">
                                  <span>Software Engineer Intern</span>
                                  <span className="text-sm text-[#433E0E] font-medium">May 2024 - August 2024</span>
                                </h2>
                                <div className="space-y-3 text-base md:text-lg leading-relaxed mt-4">
                              ...
                              <div className="border-b pb-4 mb-4">
                                <h2 className="text-lg md:text-xl font-semibold flex flex-col sm:flex-row sm:items-center gap-2">
                                  <span>Software Engineer Intern</span>
                                  <span className="text-sm text-[#433E0E] font-medium">May 2023 - August 2023</span>
                                </h2>
                                <div className="space-y-3 text-base md:text-lg leading-relaxed mt-4">
